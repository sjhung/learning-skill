...
class LearningSkill(FallbackSkill):
    def __init__(self):
        ...
        self.local_path = "/home/steve/.mycroft/learning-skill/private"
        #self.settings.get('public_path'),
        self.public_path = "/home/steve/.mycroft/learning-skill/public"
        #self.settings.get('allow_category'),
        self.allow_category = ["humor", "love", "science"]
        #self.intent_path = "/home/steve/.mycroft/skills/LearningSkill/public/humor/vocab/de-de/hallo"
        self.privacy = ""
        self.catego = ""
        self.Category = ""
    ...
    def handle_fallback(self, message):
        ...
        if not os.path.exists(self.local_path) or os.path.exists(self.public_path):
